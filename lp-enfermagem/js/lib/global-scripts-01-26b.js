var lp_enfermagem = {
  ...
  blaScripts: function () {
    ...
    script = document.createElement("script");
    script.src =
      "https://cdn.statically.io/gh/lucida-brasil/cro-kroton/main/lp-enfermagem/js/scripts-01-26b.js";
    script.async = true;
    script.defer = "defer";
    document.body.appendChild(script);
  },
  ...
  openHead: function () {
    ...
    styles = document.createElement("link");
    styles.href =
      "https://cdn.statically.io/gh/lucida-brasil/cro-kroton/main/lp-enfermagem/css/style-01-26b.css";
  ...
  init: function () {
    ...
    document.querySelector("#main-container").classList.add("lp-enfermagem");
